...
function ParallaxCard({ image, text, index }: { image: string; text: string; index: number }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#000000] font-light text-[20px] leading-[1.5]">{text}</p>
    </motion.div>
  );
}
...
export default function DetailsGrid() {
  return (
    <section className="bg-[#ffffff] py-[100px] md:py-[200px] px-6">
      <div className="max-w-[1300px] mx-auto">
        <div className="text-center mb-20">
          <ScrollReveal
            as="h2"
            className="font-light text-[#000000] tracking-[0.05em]"
          >
