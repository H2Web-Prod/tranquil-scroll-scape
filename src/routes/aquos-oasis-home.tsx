...
const diferenciais = [
  ...
  "Coberturas com segunda piscina de vidro no teto, com fundo e laterais em vidro, conceito raro no Brasil",
  "Apenas 12 unidades em um terreno de 5.000 m²",
  "Projeto em co-criação com a Architects Office",
  "Paisagismo assinado por Rodrigo Oliveira",
  "Iluminação assinada pelo OM Studio Lighting",
